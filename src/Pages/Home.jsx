...
const WORDS = ["Computer Science Student", "Tech Enthusiast", "Product Enthusiast"]
const TECH_STACK = ["Kotlin", "TypeScript", "Next.JS", "Vue.JS", "Jetpack Compose"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/firdausattalea" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/firdausattalea/" },
  { icon: Instagram, link: "https://www.instagram.com/firdausattalea/?hl=id" }
];
...
const Home = () => {
  ...
  const lottieOptions = {
    src: "https://lottie.host/a40fbec7-5447-46f6-a650-e487ab93f3fe/B0MzXBi5dt.lottie",
    loop: true,
    autoplay: true,
    rendererSettings: {
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  Menciptakan Digital Solution yang Inovatif dan Absolute
                </p>
